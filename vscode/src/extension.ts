...
// TODO: Add a "run build step" command or similar, which is based on `zig build --list-steps`, where it gets the steps and its descriptions, to then run `zig build <step>`, this could be a command option or a sidebar? maybe? Whichever is the best UX for it.
