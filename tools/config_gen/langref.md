<!--
Source: https://ziglang.org/documentation/0.16.0/ (Builtin Functions section only)
Fetched: 2026-07-15
Converted with Markitdown from the rendered HTML; headings cleaned to plain ### @name.
Do not edit by hand — re-fetch and re-convert when bumping the Zig docs version.
-->
